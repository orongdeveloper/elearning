...
class Message extends MY_Controller
{
    ...
    public function index($segment_3 = '', $segment_4 = '')
    {
        if (!empty($_GET['q'])) {
    ...
    public function detail($segment_3 = '')
    {
    ...
    public function del_all($segment_3 = '')
    {
        $msg_id = (int) $segment_3;
    ...
    public function del($segment_3 = '', $segment_4 = '')
    {
        $msg_id = (int) $segment_3;
        $retrieve = $this->msg_model->retrieve(get_sess_data('login', 'id'), $msg_id);
    ...
    public function to($segment_3 = '', $segment_4 = '')
    {
