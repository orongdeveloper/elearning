 ...
 * @since     1.0
 * @link      http://engelbertus.netlify.app
 *
 * INDEMNITY
...
class MY_Controller extends CI_Controller
{
     ...
     * @return boolean
     */
    public function update_nis($nis = '')
    {
        if (!empty($nis)) {
     ...
     * @return boolean
     */
    public function check_penerima_pesan($username = '')
    {
     ...
     * @return boolean
     */
    public function check_tgl_tampil($tgl_tampil = '')
    {
        $valid = true;
        if (empty($tgl_tampil)) {
            $valid = false;
     ...
     * @return boolean
     */
    public function create_img_thumb($source_path = '', $marker = '_thumb', $width = '90', $height = '90')
    {
     ...
     * @return array
     */
    public function get_jadwal_mapel_siswa($siswa_id)
    {
     ...
     * @return array
     */
    public function get_user_data($login_id)
    {
     ...
     * @return array
     */
    public function format_msg($retrieve)
    {
     ...
     * @return array
     */
    public function format_komentar($retrieve)
    {
     ...
     */
    public function cek_mode_ujian()
    {
     ...
     * @return integer
     */
    public function reset_nilai_jawaban($siswa_id, $tugas_id, $db_tugas = array())
    {
        # ambil data tugas
        if (empty($db_tugas)) {
     ...
     * @since 2.0
     */
    public function check_urgent_info($skip_check_time = false)
    {
